// File: presentation/ui/call/DirectCallActivity.kt
...
class DirectCallActivity : AppCompatActivity() {
    ...
    private val viewModel: DirectCallViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Direct call without server mediation for guest mode
        viewModel.initiateDirectCall(targetUserId!!, callType)
    ...
    private fun setupUI() {
        binding.apply {
            tvRemoteUserName.text = "User: $targetUserId"
    ...
    private fun startCallService() {
        val serviceIntent = Intent(this, CallService::class.java).apply {
            ...
            putExtra("remoteUserName", targetUserId)
        }
...
// File: presentation/ui/call/DirectCallViewModel.kt
package com.voipex.android.presentation.ui.call
...
class DirectCallViewModel @Inject constructor(
    ...
    fun initiateDirectCall(remoteUserId: String, callType: CallType) {
        viewModelScope.launch {
            try {
                ...
                // For guest mode, create a simple room ID
                currentRoomId = "guest-${UUID.randomUUID()}"
                signallingClient.joinRoom(currentRoomId!!)
